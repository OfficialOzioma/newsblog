                                    ...
                                    <tbody>
                                        ...
                                        <?php if($user->withActivation != null): ?>
                                            ...
                                            <tr role="row" id="row_<?php echo e($user->id); ?>" class="odd">
                                                ...
                                                <td>
                                                    <?php if(isFileExist(@$user->image, @$user->image->thumbnail)): ?>
                                                        <img
                                                            src=" <?php echo e(basePath($user->image)); ?>/<?php echo e($user->image->thumbnail); ?> "
                                                            data-src="<?php echo e(basePath($user->image)); ?>/<?php echo e($user->image->thumbnail); ?>"
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/officialozioma/Downloads/zip/project/onno/onno/Modules/User/Providers/../Resources/views/users.blade.php ENDPATH**/ ?>