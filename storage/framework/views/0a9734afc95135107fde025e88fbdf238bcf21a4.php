<?php if(Request::url() === url('/')): ?>
    ...
    <meta property="og:description" content="<?php echo e(strip_tags(\Illuminate\Support\Str::limit(settingHelper('og_description'), 130))); ?>" />
    ...
    <?php if(settingHelper('og_image') != Null): ?>
        <meta name="og:image" content="<?php echo e(asset(settingHelper('og_image'))); ?>" />
    <?php else: ?>
        <meta name="og:image" content="<?php echo e(static_asset('default-image/default-730x400.png')); ?>" alt="<?php echo settingHelper('og_title'); ?>" />
    <?php endif; ?>

    
    <meta name="twitter:title" content="<?php echo e(settingHelper('og_title')); ?>" />
    <meta name="twitter:description" content="<?php echo e(strip_tags(\Illuminate\Support\Str::limit(settingHelper('og_description'), 130))); ?>" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:domain" content="<?php echo e(url('/')); ?>" />
    <meta name="twitter:url" content="<?php echo e(url('/')); ?>">
    <?php if(settingHelper('og_image') != Null): ?>
        <meta name="twitter:image" content="<?php echo e(asset(settingHelper('og_image'))); ?>" />
    <?php else: ?>
    ...
    <?php if(\Request::route()->getName() == "article.detail"): ?>
        <?php if(isset($post)): ?>
            ...
            <?php if(isFileExist(@$post->image, @$post->image->og_image)): ?>
                <meta name="og:image" content="<?php echo e(basePath(@$post->image)); ?>/<?php echo e(@$post->image->og_image); ?>" alt="<?php echo $post->title; ?>"/>
            <?php else: ?>
                <meta name="og:image" content="<?php echo e(static_asset('default-image/default-730x400.png')); ?>" alt="<?php echo $post->title; ?>"/>
            <?php endif; ?>
...
<?php if(!blank(\Request::route())): ?>
    <?php if(\Request::route()->getName()== "site.page"): ?>
       ...
       <?php if(isFileExist(@$page->image, @$page->image->og_image)): ?>
            <meta name="og:image" content="<?php echo e(basePath(@$page->image)); ?>/<?php echo e(@$page->image->og_image); ?>" alt="<?php echo $page->title; ?>"/>
        <?php else: ?>
            <meta name="og:image" content="<?php echo e(static_asset('default-image/default-730x400.png')); ?>" alt="<?php echo $page->title; ?>"/>
        <?php endif; ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/officialozioma/Downloads/zip/project/onno/onno/resources/views/site/partials/seo_og.blade.php ENDPATH**/ ?>