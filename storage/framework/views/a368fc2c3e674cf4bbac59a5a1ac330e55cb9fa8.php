            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="form-group text-center">
                                    <img src="<?php echo e(static_asset('default-image/default-100x100.png')); ?> " id="perview_current_image"
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="ajax-loading" id="ajax-image-loading"><img src="<?php echo e(static_asset('site/images/preloader-2.gif')); ?>"/>
                        </div>
                            ...
                            .done(function (response) {
                                ...
                                if (response.status == "success") {
                                    ...
                                    if($('#image_id').val() == selected_image_id){
                                        ...
                                        $('#image_preview').attr('src', '<?php echo e(static_asset('default-image/default-100x100.png')); ?>');
                                    }
                                    console.log($('#image_id').val(''));
...
<?php /**PATH /home/officialozioma/Downloads/zip/project/onno/onno/Modules/Gallery/Providers/../Resources/views/image-gallery.blade.php ENDPATH**/ ?>