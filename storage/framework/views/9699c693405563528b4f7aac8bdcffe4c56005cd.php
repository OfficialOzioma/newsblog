                                        ...
                                        <tr role="row" id="row_<?php echo e($ad->id); ?>" class="odd">
                                            ...
                                            <td>
                                                <?php if(@$ad->ad_type == 'image'): ?>
                                                    <?php if(isFileExist(@$ad->adImage, @$ad->adImage->thumbnail)): ?>
                                                        <img src="<?php echo e(basePath($ad->adImage)); ?>/<?php echo e($ad->adImage->thumbnail); ?>" data-src="<?php echo e(basePath($ad->adImage)); ?>/<?php echo e($ad->adImage->thumbnail); ?>" alt="<?php echo e($ad->ad_name); ?>" id="image_preview"  width="64" height="64" alt="image" class="img-responsive img-thumbnail">
                                                    <?php else: ?>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/officialozioma/Downloads/zip/project/onno/onno/Modules/Ads/Providers/../Resources/views/index.blade.php ENDPATH**/ ?>