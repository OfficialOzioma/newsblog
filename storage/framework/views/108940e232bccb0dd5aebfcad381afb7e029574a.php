...
<div class="dashboard-header">
                    ...
                    <li class="nav-item dropdown nav-user">
                        <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <?php if(Sentinel::getUser()->image != null): ?>
                                <img src=" <?php echo e(basePath(Sentinel::getUser()->image)); ?>/<?php echo e(Sentinel::getUser()->image['thumbnail']); ?> " class="user-avatar-md rounded-circle"   alt="<?php echo e(Sentinel::getUser()->first_name); ?>"  >
                            <?php else: ?>
    ...
    <!-- end navbar -->
    <!-- ============================================================== -->
<?php /**PATH /home/officialozioma/Downloads/zip/project/onno/onno/Modules/Common/Providers/../Resources/views/layouts/header.blade.php ENDPATH**/ ?>