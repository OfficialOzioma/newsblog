                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="predefined_header" id="predefined_header"
                                                          class="form-control"><?php echo e(settingHelper('predefined_header')); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="custom_header_style" id="custom_header_style"
                                                          class="form-control"><?php echo e(settingHelper('custom_header_style')); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/officialozioma/Downloads/zip/project/onno/onno/Modules/Setting/Providers/../Resources/views/custom_setting.blade.php ENDPATH**/ ?>